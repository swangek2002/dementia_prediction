...
#SBATCH --output=/rds/projects/s/subramaa-mum-predict/CharlesGadd_Oxford/FoundationModelOutput/TransformerMLP_PreTrain.out
...
# 
echo "Training Foundation Model TransformerMLP example"
