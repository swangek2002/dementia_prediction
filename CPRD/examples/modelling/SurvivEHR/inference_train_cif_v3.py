"""
inference_train_cif_v3.py
=========================
Run V3 model inference on the V3 TRAIN set to extract per-patient CIF_dementia.
Used for second-round self-training (V4 candidate selection).
...
BATCH_SIZE = 16
NUM_WORKERS = 12
OUTPUT_CSV = "/Data0/swangek_data/991/CPRD/data/train_cif_dementia_v3.csv"
