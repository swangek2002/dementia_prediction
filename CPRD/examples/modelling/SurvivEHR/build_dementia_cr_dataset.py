...
Usage:
    python build_dementia_cr_dataset.py
"""
...
OUTPUT_DS_PATH = "/Data0/swangek_data/991/CPRD/data/FoundationalModel/FineTune_Dementia_CR/"
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("  Building Dementia Competing-Risk Fine-Tuning Dataset")
    print("=" * 70)
    ...
    print(f"\nDone. Use config_FineTune_Dementia_CR.yaml to run fine-tuning.")
