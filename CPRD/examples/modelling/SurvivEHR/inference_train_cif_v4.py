"""
inference_train_cif_v4.py
=========================
Run V4 model inference on the V4 TRAIN set to extract per-patient CIF_dementia.
Used for third-round self-training (V5 candidate selection, top 5%).
...
Usage:
    ...
    python inference_train_cif_v3.py
"""
...
BATCH_SIZE = 16
NUM_WORKERS = 12
OUTPUT_CSV = "/Data0/swangek_data/991/CPRD/data/train_cif_dementia_v4.csv"
