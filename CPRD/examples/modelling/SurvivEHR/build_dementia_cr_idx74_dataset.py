"""
build_dementia_cr_idx74_dataset.py
===================================
Build a competing-risk fine-tuning dataset for dementia prediction.
Index age = 74, with purified dementia labels (31 codes, 10 non-dementia removed).
...
Usage:
    python build_dementia_cr_idx74_dataset.py
"""
...
OUTPUT_DS_PATH = "/Data0/swangek_data/991/CPRD/data/FoundationalModel/FineTune_Dementia_CR_idx74/"
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("  Building Dementia CR Dataset (INDEX_AGE=74, 31 pure codes)")
    print("=" * 70)
    ...
    print(f"\nDone. Use config_FineTune_Dementia_CR_idx74.yaml to run fine-tuning.")
