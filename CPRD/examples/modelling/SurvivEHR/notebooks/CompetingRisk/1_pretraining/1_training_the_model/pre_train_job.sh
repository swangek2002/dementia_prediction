...
#SBATCH --output=/rds/projects/s/subramaa-mum-predict/CharlesGadd_Oxford/FoundationModelOutput/SurvivEHR_cr-small-192_%A.out
...
# 
echo "Training Foundation Model survival example"
...
# \
#     experiment.run_id=SurvivEHR-cr-small-192 \
