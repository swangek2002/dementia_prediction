"""
build_dementia_cr_idx75_dataset.py
===================================
Build a competing-risk fine-tuning dataset for dementia prediction.
Index age = 75, with purified dementia labels (31 codes, 10 non-dementia removed).

Cohort definition:
  - Index: Age 75
  - Outcomes: 31 pure Dementia Read codes (k=1) + DEATH (k=2)
...
Usage:
    python build_dementia_cr_idx75_dataset.py
"""
...
OUTPUT_DS_PATH = "/Data0/swangek_data/991/CPRD/data/FoundationalModel/FineTune_Dementia_CR_idx75/"
...
# Eu057, Eu04., Eu053, Eu04z, Eu0z., Eu060, Eu054, Eu05y, Eu052, Eu062)
DEMENTIA_READ_CODES = [
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("  Building Dementia CR Dataset (INDEX_AGE=75, 31 pure codes)")
    print("=" * 70)
    ...
    for split in ["train", "val", "test"]:
        (Path(OUTPUT_DS_PATH) / f"split={split}").mkdir(parents=True, exist_ok=True)
    ...
    print(f"\nDone. Use config_FineTune_Dementia_CR_idx75.yaml to run fine-tuning.")
